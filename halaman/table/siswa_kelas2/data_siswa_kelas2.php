<?php 
  if(isset($_GET['delete'])){
    ...
    if ($query_delete == TRUE) {
      echo "<script>window.location.href='?halaman=data_siswa_kelas2'</script>";
    }else{
              ...
              <table id="example1" class="table table-striped dataTable no-footer">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $query = mysqli_query($koneksi,"SELECT * FROM siswa WHERE kelas=2 ORDER BY nama_siswa ASC") or die(mysqli_error());
                        $no=1;
                      ...
                      ?>  
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-warning" href="?halaman=edit_data_siswa_kelas2&id=<?php echo $data['nis'] ?>"><li class="fa fa-pencil"></li></a>
                            <a class="btn btn-danger " href="?halaman=data_siswa_kelas2&delete=<?php echo $data['nis'] ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data?')"> <li class="fa fa-close"></li> </a>
                            <a class="btn btn-success" href="?halaman=data_siswa_kelas2&naik=<?php echo $data['nis'] ?>" onclick="return confirm('Data terhapus saat siswa naik kelas, Yakin?')"> <li class="fa fa-arrow-up"></li> </a>
                          </td>  
                        </tr>
                        <?php $no++;} ?>
                    </tbody>
    ...
    $(document).ready(function () {
      $("#tambah").hide();
        ...
        $(".click-edit").click(function(e) {
            var m = $(this).attr("id");
            $.ajax({
                url: "halaman/table/siswa_kelas2/edit.php",
                type: "POST",
                data : {id: m,},
