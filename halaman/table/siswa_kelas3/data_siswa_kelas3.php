                      ...
                      ?>  
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-success" href="?halaman=data_siswa_kelas3&naik=<?php echo $data['nis'] ?>" onclick="return confirm('Data terhapus saat siswa naik kelas, Yakin?')"> <li class="fa fa-arrow-up"></li> </a>
                          </td>  
                        </tr>
                        <?php $no++;} ?>
                    </tbody>
