    ...
    <div class="col-md-10 col-sm-offset-1">
      <div class="box box-info">
            <div class="box-header">
                <form class="form-horizontal" action="?halaman=aksi5" method="POST" >
                  <div class="box-body">
                      ...
                      <div class="col-sm-3">
                       <select class="form-control select2" style="width: 100%;" name="nis" id="nis" required="required">
                        <option value="" readonly>---Select---</option>
                          <?php 
                          $query = mysqli_query($koneksi,"SELECT * FROM siswa WHERE kelas = 5 ORDER BY nama_siswa ASC") or die(mysqli_error());
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#mauapa").change(function(e) {
            var m = $("#mauapa").val();
            $.ajax({
                url: "halaman/nilai/kelas5/mauapa.php",
                type: "POST",
                data : {id: m,},
